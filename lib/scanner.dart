  ...
  return Stack(
    children: [
      ...
      DraggableScrollableSheet(
        initialChildSize: 0.2, // terlihat sebagian
        minChildSize: 0.1,
        maxChildSize: 0.85, // bisa dibuka lebar hampir layar penuh
        builder: (context, scrollController) {
          return Container(
            ...
            child: SingleChildScrollView(
              controller: scrollController, // ini penting untuk scroll konten panjang
              child: Column(
